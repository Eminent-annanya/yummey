...
function initAdmin(socket) {
  ...
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default().get('/admin/orderes', {
    headers: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initAdmin); // <td class="border px-4 py-2">
...
function updateCart(menu) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', menu).then(function (res) {
...
var alretMessage = document.querySelector("#success-alert");
...
updateStatus(order); // payment gateway

(0,_stripe__WEBPACK_IMPORTED_MODULE_4__["default"])(); // socket connection with call back of admin
...
function initStripe() {
  ...
  var payment = document.querySelector("#payment-form");
  ...
  if (payment) {
    ...
    payment.addEventListener('submit', function (e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().post('/cart/order', formObject).then(function (res) {
        cartCounter.innerText = res.data.totalQty;
        sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
          position: 'bottom-end',
          icon: 'success',
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkyummey_recent"] = self["webpackChunkyummey_recent"] || [];
